...
ax.plot(voltage[0,:], voltage[4,:], "-.", linewidth=2.0, color="blue", label="V_m NESTML_synapse")
ax2.plot(voltage[0,:], voltage[3,:], "-", linewidth=2.0, color="orange", label="V_m tsodyks3_synapse")
ax2.plot(voltage[0,:], voltage[4,:], "-.", linewidth=2.0, color="blue", label="V_m NESTML_synapse")
