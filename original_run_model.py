...
simulation_p = {
    # path to data
    "data_path" : os.path.join(os.getcwd(), 'data_2A_thin_testsignal/'),
...
network.add_nonspecific_readout_signal(origin=[tpresim+1100.0], specific=False, popids = [0])
#network.add_nonspecific_readout_signal(origin=[tpresim+500.0], specific=False, popids = [0])
