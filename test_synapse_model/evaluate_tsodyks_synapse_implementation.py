"""
Example of Tsodyks synapse in NESTML implementation
---------------------------------------------------
...
to the presynaptic neuron using the NESTML implementation of the 
Tsodyks synapse model used in [1].

[1] Tiddia G, Sergi L, Rubiu S, Incollu A and Golosio B
